...
cockroach sql --insecure --url "postgresql://root@${TARGET}:26257/?sslmode=disable" --insecure --execute "CREATE CHANGEFEED FOR TABLE kv.kv INTO 'webhook-https://${DIR}:30004/kv/public?insecure_tls_skip_verify=true' WITH updated, resolved='1s';"
