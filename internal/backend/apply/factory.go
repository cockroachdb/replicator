...
var _ sinktypes.Appliers = (*factory)(nil)

// New returns an instance of sinktypes.Appliers.
func New(watchers sinktypes.Watchers) (_ sinktypes.Appliers, cancel func()) {
