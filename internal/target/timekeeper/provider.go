...
// ProvideTimeKeeper is called by Wire to construct the TimeKeeper. This
// provider will start a background goroutine to retire old, resolved
// timestamps form the TargetTable.
