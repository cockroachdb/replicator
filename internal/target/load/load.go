...
// ErrUnimplemented is returned from [Loader.Load] if the target
// database is not supported.
var ErrUnimplemented = errors.New("loading not implemented for this target database")
