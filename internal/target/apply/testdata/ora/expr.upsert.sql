...
SELECT CAST(:p1 AS VARCHAR(256)), CAST(:ref2+:ref2 AS INT), CAST('fixed' AS VARCHAR(256)), CAST(:ref3||'foobar' AS VARCHAR(256)), CASE WHEN :p4 IS NOT NULL THEN CAST(:p5 AS INT8) ELSE expr() END FROM DUAL
)
