...
var (
	resolveActive = promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "resolve_active",
		Help: "a flag to indicate that this instance is the active resolver",
	...
	resolveLastAttempt = promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "resolve_flush_attempt_seconds",
		Help: "the wall time at which the last resolve attempt was made",
	}, metrics.SchemaLabels)
