...
func (r *resolve) Flush(ctx context.Context) (hlc.Time, bool, error) {
	...
	err := retry.Retry(ctx, func(ctx context.Context) error {
		...
		var foundWork bool
		resolved, foundWork, err = r.dequeueInTx(ctx, tx)
		if err != nil {
			return err
		}
		if !foundWork {
...
func (r *resolve) dequeueInTx(ctx context.Context, tx pgxtype.Querier) (hlc.Time, bool, error) {
	...
	return hlc.New(sourceNanos, sourceLogical), true, nil
}
