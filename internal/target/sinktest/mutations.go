...
// Payload instances are generated by a MutationGenerator.
type Payload struct {
...
// MutationGenerator returns a channel from which an infinite number of
...
func MutationGenerator(
	ctx context.Context, idCount int, deleteFraction float32,
) <-chan types.Mutation {
