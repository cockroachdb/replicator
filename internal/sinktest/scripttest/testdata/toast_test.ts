...
// Sample userscript to deal with toasted columns.
// It requires the --toastedColumPlaceholder to be set
// to "__cdc__toast__".
// It also leverages a cas colum that forces a conflict.
// In this case, just a boolean that will be always false.
