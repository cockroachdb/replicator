...
// sequencer has finished processing a cursor and the
// [types.BatchCursor.Tag] field is non-nil.
type TerminalFunc func(ctx *stopper.Context, tag any, err error) error
