...
// maybeGZip compresses the given data if it is larger than a threshold
// value. GZIP has about 1k of overhead for the dictionary, so zipping
// small amounts of data isn't actually going to buy us anything.
