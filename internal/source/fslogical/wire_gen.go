...
func Start(contextContext context.Context, config *Config) ([]*logical.Loop, func(), error) {
	...
	fslogicalTombstones, err := ProvideTombstones(contextContext, config, client, factory)
	if err != nil {
		cleanup6()
		cleanup5()
		cleanup4()
	...
	v, cleanup7, err := ProvideLoops(contextContext, config, factory, client, fslogicalTombstones)
	if err != nil {
		cleanup6()
		cleanup5()
		cleanup4()
...
func startLoopsFromFixture(fixture *sinktest.Fixture, config *Config) ([]*logical.Loop, func(), error) {
	...
	v, cleanup4, err := ProvideLoops(contextContext, config, factory, client, fslogicalTombstones)
	if err != nil {
		cleanup3()
		cleanup2()
		cleanup()
