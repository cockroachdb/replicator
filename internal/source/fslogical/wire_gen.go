...
func Start(contextContext context.Context, config *Config) ([]*logical.Loop, func(), error) {
	...
	tombstones, cleanup7, err := ProvideTombstones(config, client, factory, userScript)
	if err != nil {
		cleanup6()
		cleanup5()
		cleanup4()
...
func startLoopsFromFixture(fixture *all.Fixture, config *Config) ([]*logical.Loop, func(), error) {
	...
	factory, err := logical.ProvideFactory(contextContext, appliers, configs, baseConfig, typesMemo, loader, stagingPool, targetPool, watchers, checker)
	if err != nil {
		cleanup3()
		cleanup2()
		cleanup()
