...
type logToKVTestCase struct {
	input          string
	expectedKV     oracleparser.SetAndWhereKVStructs
	...
	for i, tc := range []logToKVTestCase{
		{
			...
			expectedKV: oracleparser.SetAndWhereKVStructs{
				ValKV: oracleparser.KVStruct{
					"ID":          "1",
					"NAME_TARGET": "hello",
					"SALARY":      "123",
				},
				WhereKV: make(oracleparser.KVStruct),
			},
		},
		{
			...
			expectedKV: oracleparser.SetAndWhereKVStructs{
				...
				WhereKV: oracleparser.KVStruct{
					"SALARY": "123",
					"ROWID":  "AAASLzAAHAAAAFeAAA",
				},
			},
		},
		{
			...
			expectedKV: oracleparser.SetAndWhereKVStructs{
				ValKV: oracleparser.KVStruct{
					"FIELD0":           "(Fe?2l$N)-9&\"<<-_\\x7f8$4,Es7 0=D+,A+(($&?z*7j",
					"FIELD1":           "2M'')364^k3D%<[/-V=4;6=L)!H58C''$Ss:3j''%.-U5",
					"FIELD2":           "$60%:|&^}/*&<I+8];''+~3E-/_e\"2n''Mm/.r&.($Qs",
					"FIELD3":           nil,
					"FIELD4":           nil,
					"FIELD5":           nil,
					"FIELD6":           nil,
					...
					"FIELD8":           nil,
					"FIELD9":           nil,
					"SOURCE_TIMESTAMP": "24-09-10 12:53:38,543044000",
					"YCSB_KEY":         "user8285893862370130496",
				},
				WhereKV: make(oracleparser.KVStruct),
			},
		},
		{
			...
			expectedKV: oracleparser.SetAndWhereKVStructs{
				ValKV: oracleparser.KVStruct{
					"FIELD0":           "4X)-^o8Q31Yi>V)12p4Dc\"T?$Bu6_k-D916h?$\"4\\+",
					"SOURCE_TIMESTAMP": "24-09-10 12:53:38,532918000",
				},
				WhereKV: oracleparser.KVStruct{
					"FIELD0":           "?Z;9?,>Be#Yg<6b&U#%:0=)b582$Lu)\\o7/v?[m/]m",
					"SOURCE_TIMESTAMP": "24-09-10 12:53:38,487742000",
					"ROWID":            "AAASMEAAHAAAAFdAAZ",
				},
			},
		},
		{
			input: `delete from "C##MYADMIN"."USERTABLE" where "YCSB_KEY" = 'user8285893862370130496' and "FIELD0" = '(Fe?2l$N)-9&"<<-_\x7f8$4,Es7 0=D+,A+(($&?z*7j' and "FIELD1" = '2M'')364^k3D%<[/-V=4;6=L)!H58C''$Ss:3j''%.-U5'  and "FIELD7" IS NULL and "SOURCE_TIMESTAMP" = TO_TIMESTAMP('24-09-10 12:53:38,543044000') and ROWID = 'AAASMEAAHAAAAFfAAE';`,
			expectedKV: oracleparser.SetAndWhereKVStructs{
				ValKV: make(oracleparser.KVStruct),
				WhereKV: oracleparser.KVStruct{
					"YCSB_KEY":         "user8285893862370130496",
					"FIELD0":           "(Fe?2l$N)-9&\"<<-_\\x7f8$4,Es7 0=D+,A+(($&?z*7j",
					"ROWID":            "AAASMEAAHAAAAFfAAE",
					"FIELD1":           "2M'')364^k3D%<[/-V=4;6=L)!H58C''$Ss:3j''%.-U5",
					"FIELD7":           nil,
					"SOURCE_TIMESTAMP": "24-09-10 12:53:38,543044000",
				},
		...
		},
		{
			...
			expectedKV: oracleparser.SetAndWhereKVStructs{
				ValKV: oracleparser.KVStruct{
					"TSCOL": "24-09-10 12:53:38,543044000",
				},
				WhereKV: make(oracleparser.KVStruct),
			},
		},
