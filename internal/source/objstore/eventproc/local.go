...
type Acceptor interface {
	// AcceptMultiBatch process a MultiBatch.
...
// Local creates a local processor.
func Local(
	acceptor Acceptor, bucket bucket.Reader, parser *cdcjson.NDJsonParser, schema ident.Schema,
) Processor {
