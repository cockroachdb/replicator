...
that is strictly less than then minTimestamp in the Kafka feed.
The optimal value for resolvedInterval is the same as to the min_checkpoint_frequency/resolved 
