...
func (c *conn) Process(
	...
	// On Postgres version before v15, there could be empty transactions,
	// on mutations that are not part of the publication slots.
	...
	for msg := range ch {
		...
		case *pglogrepl.BeginMessage:
			...
			emptyTransaction = c.skipEmptyTransactions
			continue
