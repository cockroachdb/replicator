...
// ProvideAuthenticator is called by Wire.
...
// ProvideMetaTable is called by Wire.
...
// ProvideListener is called by Wire.
...
func ProvidePool(ctx context.Context, config Config) (*pgxpool.Pool, func(), error) {
	cfg, err := pgxpool.ParseConfig(config.ConnectionString)
	if err != nil {
...
// ProvideTimeTable is called by Wire.
...
// ProvideTLSConfig is called by Wire.
