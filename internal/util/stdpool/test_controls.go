...
func WithTestControls(tc TestControls) Option {
	return &withTestControls{tc}
}

type withTestControls struct {
	tc TestControls
}

func (o *withTestControls) option() {}
func (o *withTestControls) testControls(ctx context.Context, tc *TestControls) error {
	*tc = o.tc
	return nil
}
