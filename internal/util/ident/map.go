...
func (m *IdentifierMap[I, V]) Entries() []cmap.Entry[I, V] {
	if m.data != nil {
		...
		sort.Slice(ret, func(i, j int) bool {
			return ret[i].Key.Raw() < ret[j].Key.Raw()
		})
		return ret
	}
	return nil
...
// PutErr can be passed to Range to copy the contents of one Map into
// another. It always returns nil.
func (m *IdentifierMap[I, V]) PutErr(key I, value V) error {
	m.Put(key, value)
	return nil
}
